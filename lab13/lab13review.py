...
class  Chair:
    ...
    # method to pass the length of the chair
    ...
    def chair_description(self):
        return f"The total vovlume of the chair is {self.chair_volume()}. The chair color is {self.get_color()}."
    
    # method with a priavate property
    def setprice(self, price):
        self._chairprice = price #  one underscore makes the property protected, but it is still accessible outside the class
